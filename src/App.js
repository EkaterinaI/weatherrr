        ...
        <div className="wrapper">
          <div className="container">
            <div className="row main">
              <div className="col-lg-5 col-md-5 col-sm-6 col-xs-6 title-container">
                <div className="favorites">
                  <h3>Favorites</h3> 
                  {
                    citiesMap.map(function(cityName, index) {
                      return(
                        <div className="city-box" onClick={this.onCityClick.bind(this, cityName)}>
                ...
                <div className="col-lg-7 col-md-7 col-sm-6 col-xs-6 form-container">
